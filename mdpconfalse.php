...
if (isset($_POST['valid_connection'])) {
    if (
        ...
        // Récupérez le nom d'utilisateur (Prénom) et le mot de passe saisis dans le formulaire
        ...
        // Requête SQL pour récupérer le mot de passe crypté associé à l'utilisateur (Prénom)
...
<body>
    ...
    <main>
        ...
        <div class="conform">
            <div class="fotcon">
                <h1 class="fotcon2">WASTED : Mot de passe incorrect. Veuillez réessayer.</h1>
            </div>
